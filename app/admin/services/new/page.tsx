    ...
    try {
      ...
      if (!res.ok) {
        if (json.fields) {
          ...
          setErrors({ general: json.error || "Failed to create service" });
        }
        return;
      }
      ...
      <div className="flex flex-col gap-8">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            <h1 className="font-display text-4xl font-bold tracking-tight text-text sm:text-5xl">New Service</h1>
            <p className="text-lg text-muted">Add a new expertise or offering to your portfolio.</p>
          </div>
        </div>
