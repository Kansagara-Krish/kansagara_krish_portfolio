...
import { Save, ArrowLeft, Loader2, Trophy, MapPin, Calendar, Link as LinkIcon, Image as ImageIcon, Layout, Target, Award } from "lucide-react";
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="flex flex-col gap-2">
            <h1 className="font-display text-4xl font-bold tracking-tight text-text sm:text-5xl">New Hackathon</h1>
            <p className="text-lg text-muted">Document your latest competitive coding achievement.</p>
          </div>
