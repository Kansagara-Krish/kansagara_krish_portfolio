...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      <section id="who-i-am" className="relative mx-auto max-w-6xl px-6 py-20 overflow-hidden">
        {/* Immersive Background Glows */}
        <div className="absolute -left-20 top-0 -z-10 h-[500px] w-[500px] rounded-full bg-primary/5 blur-[120px] opacity-50 pointer-events-none" />
        <div className="absolute -right-20 bottom-0 -z-10 h-[500px] w-[500px] rounded-full bg-primary/5 blur-[120px] opacity-30 pointer-events-none" />
        ...
        <StaggerContainer staggerDelay={0.12} className="grid gap-6 md:grid-cols-12 md:grid-rows-3">
          ...
          <StaggerItem className="col-span-full md:col-span-8 md:row-span-2">
            <Card className="group relative flex h-full flex-col justify-between overflow-hidden border-border/50 bg-surface/30 p-8 backdrop-blur-md transition-all duration-500 hover:border-primary/20 hover:bg-surface/50 hover:shadow-2xl hover:shadow-primary/5 lg:p-12">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-primary/10 text-primary shadow-inner mb-8 group-hover:scale-105 transition-transform">
                <Code2 size={32} />
              </div>
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                <div className="rounded-3xl border border-border/50 bg-surface/50 p-6 transition-all duration-300 hover:border-primary/20">
          ...
          <StaggerItem className="col-span-full md:col-span-4 md:row-span-2">
            <Card className="group h-full border-border/50 bg-surface/30 p-8 backdrop-blur-md flex flex-col transition-all duration-500 hover:border-primary/20 hover:bg-surface/50">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary/10 text-primary mb-8 group-hover:scale-105 transition-transform">
                <Zap size={22} />
              </div>
      ...
      <section id="featured-projects" className="border-y border-border bg-surface/50 py-24 dark:bg-surface/20">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <StaggerContainer staggerDelay={0.12} className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      <section className="mx-auto max-w-6xl px-6 py-24">
        <div className="grid gap-12 lg:grid-cols-[1fr_2fr] lg:gap-16">
          ...
          <ScrollReveal animation="fade-left" delay={0.15} className="relative">
      ...
      <section className="border-y border-border py-24">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <StaggerContainer staggerDelay={0.12} className="grid gap-8 md:grid-cols-3">
            {posts.slice(0, 3).map((cert) => (
