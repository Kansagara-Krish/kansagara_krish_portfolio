...
export default async function ProjectsPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-bg/50">
      ...
      <div className="absolute right-[-10%] top-[-10%] h-[40%] w-[40%] rounded-full bg-primary/5 blur-[120px] pointer-events-none" />
      <div className="absolute left-[-10%] bottom-[-10%] h-[40%] w-[40%] rounded-full bg-primary/5 blur-[120px] pointer-events-none" />
