      ...
      <section className="relative z-10 mx-auto max-w-6xl px-6 py-24">
        <div className="grid gap-16 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <ScrollReveal animation="fade-right" duration={0.7}>
            ...
            <StaggerContainer staggerDelay={0.12} className="mt-12 flex flex-wrap gap-10">
          ...
          <ScrollReveal animation="fade-left" delay={0.2} duration={0.7} className="relative">
            <div className="absolute -inset-4 rounded-3xl bg-gradient-to-br from-primary/10 to-transparent blur-2xl opacity-40" />
            <Card className="relative aspect-[4/5] overflow-hidden rounded-2xl border-border/50 shadow-2xl">
        ...
        <ScrollReveal animation="fade-up" className="mt-32">
          <div className="mb-12">
        ...
        <ScrollReveal animation="zoom-in" className="mt-32">
          <div className="rounded-2xl border border-border bg-surface/50 p-10 text-center backdrop-blur-md sm:p-16">
