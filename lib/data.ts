...
const projects: ProjectDTO[] = [
  {
    ...
    liveUrl: null,
    githubUrl: null,
    imageUrl: "/images/projects/convergence-thumb.jpg",
    galleryImages: [],
    projectLinks: [],
    featured: true,
    status: "completed",
  ...
  },
  {
    ...
    liveUrl: null,
    githubUrl: null,
    imageUrl: "/images/projects/resume-scanner-thumb.jpg",
    galleryImages: [],
    projectLinks: [],
    featured: true,
    status: "completed",
  ...
  },
  {
    ...
    liveUrl: null,
    githubUrl: null,
    imageUrl: "/images/projects/home-theater-thumb.jpg",
    galleryImages: [],
    projectLinks: [],
    featured: true,
    status: "completed",
...

  {
    ...
    liveUrl: null,
    githubUrl: null,
    imageUrl: "/images/projects/aura-thumb.png",
    galleryImages: [],
    projectLinks: [],
    featured: false,
    status: "completed",
...

  {
    ...
    liveUrl: null,
    githubUrl: null,
    imageUrl: "/images/projects/salary-prediction-thumb.png",
    galleryImages: [],
    projectLinks: [],
    featured: false,
    status: "completed",
...

  {
    ...
    liveUrl: null,
    githubUrl: null,
    imageUrl: "/images/projects/krushiseva-thumb.jpg",
    galleryImages: [],
    projectLinks: [],
    featured: false,
    status: "completed",
...
const certifications: CertificationDTO[] = [
  ...
  {
    id: "cert-machine-learning-for-automotive-proov",
    slug: "machine-learning-for-automotive-proov",
    name: "Machine Learning for Automotive",
    issuer: "ProoV · Artificial Intelligence & Machine Learning",
    date: "2026-06-04T00:00:00.000Z",
    url: "https://projectstudy.in",
    credentialId: "fafe76066974c23c1f78304715e77eb",
    image: "/certifications/proov_Ml_certificate.png",
